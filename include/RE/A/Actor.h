...
namespace RE
{
	...
	public:
		inline static auto           RTTI = RTTI_Actor;
...
//		void                    UnequipItem(std::uint64_t a_arg1, TESBoundObject* a_object) override;                                                                                                                                                 // 0A1
		...
		// add
		void                 Unk_A2(void);                                                                                                                                                                    // 0A2
		void                 PlayPickUpSound(TESBoundObject* a_object, bool a_pickup, bool a_use);                                                                                                            // 0A3
		float                GetHeading(bool a_ignoreRaceSettings) const;                                                                                                                                     // 0A4
		void                 SetAvoidanceDisabled(bool a_set);                                                                                                                                                // 0A5 - { return; }
		void                 DrawWeaponMagicHands(bool a_draw);                                                                                                                                               // 0A6
		void                 DetachCharController();                                                                                                                                                          // 0A7
		void                 RemoveCharController();                                                                                                                                                          // 0A8
		void                 SetPosition(const NiPoint3& a_pos, bool a_updateCharController);                                                                                                                 // 0A9
		void                 KillDying();                                                                                                                                                                     // 0AA
		void                 Resurrect(bool a_resetInventory, bool a_attach3D);                                                                                                                               // 0AB
		bool                 PutActorOnMountQuick();                                                                                                                                                          // 0AC
		void                 Update(float a_delta);                                                                                                                                                           // 0AD
		void                 UpdateNoAI(float a_delta);                                                                                                                                                       // 0AE - { return UpdateActor3DPosition(); }
		void                 UpdateCharacterControllerSimulationSettings(bhkCharacterController& a_controller);                                                                                               // 0AF
		void                 PotentiallyFixRagdollState();                                                                                                                                                    // 0B0
		void                 UpdateNonRenderSafe(float a_delta);                                                                                                                                              // 0B1
		void                 OnItemEquipped(bool a_playAnim);                                                                                                                                                 // 0B2
		void                 Unk_B3(void);                                                                                                                                                                    // 0B3 - { return 1; }
		void                 Unk_B4(void);                                                                                                                                                                    // 0B4
		void                 SetCrimeGoldValue(TESFaction* a_faction, bool a_violent, std::uint32_t a_amount);                                                                                                // 0B5
		void                 ModCrimeGoldValue(TESFaction* a_faction, bool a_violent, std::int32_t a_amount);                                                                                                 // 0B6
		void                 RemoveCrimeGoldValue(TESFaction* a_faction, std::int32_t a_amount, bool a_violent);                                                                                              // 0B7
		std::uint32_t        GetCrimeGoldValue(const TESFaction* a_faction) const;                                                                                                                            // 0B8
		void                 GoToPrison(TESFaction* a_faction, bool a_removeInventory, bool a_realJail);                                                                                                      // 0B9 - { return; }
		void                 ServePrisonTime();                                                                                                                                                               // 0BA - { return; }
		void                 PayFine(TESFaction* a_faction, bool a_goToJail, bool a_removeStolenItems);                                                                                                       // 0BB - { return; }
		bool                 GetCannibal();                                                                                                                                                                   // 0BC - { return false; }
		void                 SetCannibal(bool a_set);                                                                                                                                                         // 0BD - { return; }
		bool                 GetVampireFeed();                                                                                                                                                                // 0BE - { return false; }
		void                 SetVampireFeed(bool a_set);                                                                                                                                                      // 0BF - { return; }
		void                 InitiateVampireFeedPackage(Actor* a_target, TESObjectREFR* a_furniture);                                                                                                         // 0C0 - { return; }
		void                 InitiateCannibalPackage(Actor* a_target);                                                                                                                                        // 0C1 - { return; }
		void                 GetEyeVector(NiPoint3& a_origin, NiPoint3& a_direction, bool a_includeCameraOffset);                                                                                             // 0C2
		...
		void                 Unk_C8(void);                                                                                                                                                                    // 0C8
		void                 Unk_C9(void);                                                                                                                                                                    // 0C9
		void                 OnArmorActorValueChanged();                                                                                                                                                      // 0CA - { return; }
		ObjectRefHandle      DropObject(const TESBoundObject* a_object, ExtraDataList* a_extraList, std::int32_t a_count, const NiPoint3* a_dropLoc = 0, const NiPoint3* a_rotate = 0);                       // 0CB
		void                 PickUpObject(TESObjectREFR* a_object, std::int32_t a_count, bool a_arg3 = false, bool a_playSound = true);                                                                       // 0CC
		void                 AttachArrow(const BSTSmartPointer<BipedAnim>& a_biped);                                                                                                                          // 0CD
		void                 DetachArrow(const BSTSmartPointer<BipedAnim>& a_biped);                                                                                                                          // 0CE
		bool                 AddShout(TESShout* a_shout);                                                                                                                                                     // 0CF
		void                 UnlockWord(TESWordOfPower* a_power);                                                                                                                                             // 0D0 - { return; }
		void                 Unk_D1(void);                                                                                                                                                                    // 0D1
		std::uint32_t        UseAmmo(std::uint32_t a_shotCount);                                                                                                                                              // 0D2
		bool                 CalculateCachedOwnerIsInCombatantFaction() const;                                                                                                                                // 0D3
		CombatGroup*         GetCombatGroup() const;                                                                                                                                                          // 0D4
		void                 SetCombatGroup(CombatGroup* a_group);                                                                                                                                            // 0D5
		bool                 CheckValidTarget(TESObjectREFR& a_target);                                                                                                                                       // 0D6
		void                 Unk_D7(void);                                                                                                                                                                    // 0D7 - { return 0; }
		void                 InitiateDialogue(Actor* a_target, PackageLocation* a_loc1, PackageLocation* a_loc2);                                                                                             // 0D8
		void                 Unk_D9(void);                                                                                                                                                                    // 0D9
		void                 EndDialogue();                                                                                                                                                                   // 0DA
		Actor*               SetUpTalkingActivatorActor(Actor* a_target, Actor*& a_activator);                                                                                                                // 0DB
		void                 InitiateSpectator(Actor* a_target);                                                                                                                                              // 0DC - { return; }
		void                 InitiateFlee(TESObjectREFR* a_fleeRef, bool a_runOnce, bool a_knows, bool a_combatMode, TESObjectCELL* a_cell, TESObjectREFR* a_ref, float a_fleeFromDist, float a_fleeToDist);  // 0DD
		void                 InitiateGetUpPackage();                                                                                                                                                          // 0DE
		void                 PutCreatedPackage(TESPackage* a_package, bool a_tempPackage, bool a_createdPackage, bool a_allowFromFurniture);                                                                  // 0DF
		void                 UpdateAlpha();                                                                                                                                                                   // 0E0
		void                 SetAlpha(float a_alpha = 1.0);                                                                                                                                                   // 0E1
		float                GetAlpha();                                                                                                                                                                      // 0E2
		bool                 IsInCombat() const;                                                                                                                                                              // 0E3
		void                 UpdateCombat();                                                                                                                                                                  // 0E4
		void                 StopCombat();                                                                                                                                                                    // 0E5
		void                 Unk_E6(void);                                                                                                                                                                    // 0E6 - { return 0.0; }
		void                 Unk_E7(void);                                                                                                                                                                    // 0E7 - { return 0.0; }
		void                 Unk_E8(void);                                                                                                                                                                    // 0E8 - { return 0; }
		void                 Unk_E9(void);                                                                                                                                                                    // 0E9 - { return 0; }
		void                 Unk_EA(void);                                                                                                                                                                    // 0EA - { return 0; }
		void                 Unk_EB(void);                                                                                                                                                                    // 0EB
		void                 Unk_EC(void);                                                                                                                                                                    // 0EC
		void                 Unk_ED(void);                                                                                                                                                                    // 0ED
		void                 Unk_EE(void);                                                                                                                                                                    // 0EE
		void                 WeaponSwingCallBack();                                                                                                                                                           // 0EF
		void                 SetActorStartingPosition();                                                                                                                                                      // 0F0
		bool                 MoveToHigh();                                                                                                                                                                    // 0F1
		bool                 MovetoLow();                                                                                                                                                                     // 0F2
		bool                 MovetoMiddleLow();                                                                                                                                                               // 0F3
		void                 Unk_F4(void);                                                                                                                                                                    // 0F4
		bool                 HasBeenAttacked() const;                                                                                                                                                         // 0F5
		void                 SetBeenAttacked(bool a_set);                                                                                                                                                     // 0F6
		void                 UseSkill(ActorValue a_av, float a_points, TESForm* a_arg3);                                                                                                                      // 0F7 - { return; }
		bool                 IsAtPoint(const NiPoint3& a_point, float a_radius, bool a_expandRadius, bool a_alwaysTestHeight);                                                                                // 0F8
		bool                 IsInFaction(const TESFaction* faction) const;                                                                                                                                    // 0F9
		void                 ForEachPerk(PerkEntryVisitor& a_visitor) const;                                                                                                                                  // 0FA
		void                 AddPerk(BGSPerk* a_perk, std::uint32_t a_rank = 0);                                                                                                                              // 0FB - { return; }
		void                 RemovePerk(BGSPerk* a_perk);                                                                                                                                                     // 0FC - { return; }
		void                 ApplyTemporaryPerk(BGSPerk* a_perk);                                                                                                                                             // 0FD - { return; }
		void                 RemoveTemporaryPerk(BGSPerk* a_perk);                                                                                                                                            // 0FE - { return; }
		bool                 HasPerkEntries(EntryPoint a_entryType) const;                                                                                                                                    // 0FF
		void                 ForEachPerkEntry(EntryPoint a_entryType, PerkEntryVisitor& a_visitor) const;                                                                                                     // 100
		void                 ApplyPerksFromBase();                                                                                                                                                            // 101
		void                 StartPowerAttackCoolDown();                                                                                                                                                      // 102 - { return; }
		bool                 IsPowerAttackCoolingDown() const;                                                                                                                                                // 103 - { return false; }
		void                 HandleHealthDamage(Actor* a_attacker, float a_damage);                                                                                                                           // 104
		void                 Unk_105(void);                                                                                                                                                                   // 105
		void                 Unk_106(void);                                                                                                                                                                   // 106 - { return; }
		bool                 QSpeakingDone() const;                                                                                                                                                           // 107 - { return ~(unk0E0 >> 5) & 1; }
		void                 SetSpeakingDone(bool a_set);                                                                                                                                                     // 108
		void                 CreateMovementController();                                                                                                                                                      // 109
		void                 Unk_10A(void);                                                                                                                                                                   // 10A - { return unk16C; }
		void                 Unk_10B(void);                                                                                                                                                                   // 10B - { unk16C = a_arg1; }
		void                 Unk_10C(void);                                                                                                                                                                   // 10C - { return unk170; }
		void                 Unk_10D(void);                                                                                                                                                                   // 10D - { unk170 = a_arg1; }
		void                 KillImpl(Actor* a_attacker, float a_damage, bool a_sendEvent, bool a_ragdollInstant);                                                                                            // 10E
		void                 Unk_10F(void);                                                                                                                                                                   // 10F
		bool                 CheckCast(MagicItem* a_spell, bool a_dualCast, MagicSystem::CannotCastReason* a_reason);                                                                                         // 110
		void                 CheckTempModifiers();                                                                                                                                                            // 111 - { return; }
		std::int32_t         GetCurrentShoutLevel();                                                                                                                                                          // 112 - return -1 on error
		void                 SetLastRiddenMount(ActorHandle a_mount);                                                                                                                                         // 113 - { return; }
		ActorHandle          QLastRiddenMount() const;                                                                                                                                                        // 114 - { return {}; }
		bool                 CalculateCachedOwnerIsUndead() const;                                                                                                                                            // 115
		bool                 CalculateCachedOwnerIsNPC() const;                                                                                                                                               // 116
		void                 Unk_117(void);                                                                                                                                                                   // 117 - { return; }
		void                 Unk_118(void);                                                                                                                                                                   // 118
		const BSFixedString& GetResponseString() const;                                                                                                                                                       // 119 - { return "ActorResponse"; }
		void                 Unk_11A(void);                                                                                                                                                                   // 11A
		void                 UpdateCombatControllerSettings();                                                                                                                                                // 11B
		void                 UpdateFadeSettings(bhkCharacterController* a_controller);                                                                                                                        // 11C
		bool                 ComputeMotionFeedbackSpeedAndDirection(const ActorMotionFeedbackData& a_data, float a_delta, ActorMotionFeedbackOutput& a_output);                                               // 11D
		bool                 UpdateFeedbackGraphSpeedAndDirection(const ActorMotionFeedbackOutput& a_output);                                                                                                 // 11E
		void                 UpdateActor3DPosition();                                                                                                                                                         // 11F
		void                 PrecacheData();                                                                                                                                                                  // 120
		void                 WornArmorChanged(void);                                                                                                                                                          // 121
		void                 ProcessTracking(float a_delta, NiAVObject* a_obj3D);                                                                                                                             // 122
		void                 Unk_123(void);                                                                                                                                                                   // 123
		void                 CreateActorMover();                                                                                                                                                              // 124
		void                 DestroyActorMover();                                                                                                                                                             // 125
		bool                 ShouldRespondToActorCollision(const MovementMessageActorCollision& a_msg, const ActorHandlePtr& a_target);                                                                       // 126
		float                CheckClampDamageModifier(ActorValue a_av, float a_delta);                                                                                                                        // 127
