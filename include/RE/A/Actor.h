...
namespace RE
{
	...
	public:
		...
		virtual void                    SetCrimeGoldValue(TESFaction* a_faction, bool a_violent, std::uint32_t a_amount);                                                                                                // 0B7
		virtual void                    ModCrimeGoldValue(TESFaction* a_faction, bool a_violent, std::int32_t a_amount);                                                                                                 // 0B8
		virtual void                    RemoveCrimeGoldValue(TESFaction* a_faction, std::int32_t a_amount, bool a_violent);                                                                                              // 0B9
		virtual std::uint32_t           GetCrimeGoldValue(const TESFaction* a_faction) const;                                                                                                                            // 0BA
		...
		virtual float                   GetAcrobatics() const;                                                                                                                                                           // 0C7 - { return 1.0; }
		virtual bhkCharacterController* Move(float a_arg2, const NiPoint3& a_position);                                                                                                                                  // 0CA
		virtual void                    Unk_CB(void);                                                                                                                                                                    // 0CB
		virtual void                    OnArmorActorValueChanged();                                                                                                                                                      // 0CC - { return; }
		virtual ObjectRefHandle         DropObject(const TESBoundObject* a_object, ExtraDataList* a_extraList, std::int32_t a_count, const NiPoint3* a_dropLoc = 0, const NiPoint3* a_rotate = 0);                       // 0CD
		virtual void                    PickUpObject(TESObjectREFR* a_object, std::int32_t a_count, bool a_arg3 = false, bool a_playSound = true);                                                                       // 0CE
		...
		virtual std::uint32_t           UseAmmo(std::uint32_t a_shotCount);                                                                                                                                              // 0D4
		...
		virtual bool                    InitiateTresPassPackage(TrespassPackage* a_trespassPackage);                                                                                                                     // 0D9 - { return 0; }
		virtual void                    InitiateDialogue(Actor* a_target, PackageLocation* a_loc1, PackageLocation* a_loc2);                                                                                             // 0DA
		virtual void                    SetSize(float a_size);                                                                                                                                                           // 0DB
		...
		virtual float                   CalcArmorRating();                                                                                                                                                               // 0E8 - { return 0.0; }
		virtual float                   GetArmorBaseFactorSum();                                                                                                                                                         // 0E9 - { return 0.0; }
		virtual float                   CalcUnarmedDamage();                                                                                                                                                             // 0EA - { return 0; }
		virtual void                    Unk_EB(void);                                                                                                                                                                    // 0EB - { return 0; }
		virtual void                    Unk_EC(void);                                                                                                                                                                    // 0EC - { return 0; }
		virtual float                   GetRunSpeed();                                                                                                                                                                   // 0ED
		virtual float                   GetJogSpeed();                                                                                                                                                                   // 0EE
		virtual float                   GetFastWalkSpeed();                                                                                                                                                              // 0EF
		virtual float                   GetWalkSpeed();                                                                                                                                                                  // 0F0
		virtual void                    WeaponSwingCallBack();                                                                                                                                                           // 0F1
		virtual void                    SetActorStartingPosition();                                                                                                                                                      // 0F2
		virtual bool                    MoveToHigh();                                                                                                                                                                    // 0F3
		virtual bool                    MovetoLow();                                                                                                                                                                     // 0F4
		virtual bool                    MovetoMiddleLow();                                                                                                                                                               // 0F5
		virtual bool                    MoveToMiddleHigh();                                                                                                                                                              // 0F6
		...
		virtual void                    ForEachPerk(PerkEntryVisitor& a_visitor) const;                                                                                                                                  // 0FC
		virtual void                    AddPerk(BGSPerk* a_perk, std::uint32_t a_rank = 0);                                                                                                                              // 0FD - { return; }
		virtual void                    RemovePerk(BGSPerk* a_perk);                                                                                                                                                     // 0FE - { return; }
		virtual void                    Unk_FF(void);                                                                                                                                                                    // 0FF - { return; }
		virtual void                    Unk_100(void);                                                                                                                                                                   // 100 - { return; }
		virtual bool                    HasPerkEntries(EntryPoint a_entryType) const;                                                                                                                                    // 101
		virtual void                    ForEachPerkEntry(EntryPoint a_entryType, PerkEntryVisitor& a_visitor) const;                                                                                                     // 102
		virtual void                    ApplyPerksFromBase();                                                                                                                                                            // 103
		virtual void                    StartPowerAttackCoolDown();                                                                                                                                                      // 104 - { return; }
		virtual bool                    IsPowerAttackCoolingDown() const;                                                                                                                                                // 105 - { return false; }
		...
		virtual bool                    DrinkPotion(AlchemyItem* a_potion, ExtraDataList* a_extralist);                                                                                                                  // 111 - { return; }
		...
		virtual std::int32_t            GetCurrentShoutLevel();                                                                                                                                                          // 114 - { return {}; }
		...
		virtual void                    InitValues();                                                                                                                                                                    // 11A
		virtual const BSFixedString&    GetResponseString() const;                                                                                                                                                       // 11B
		virtual void                    ModifyMovementData(float a_delta, NiPoint3& a_arg3, NiPoint3& a_arg4);                                                                                                           // 11C
		...
		virtual bool                    ShouldRespondToActorCollision(const MovementMessageActorCollision& a_msg, const ActorHandlePtr& a_target);                                                                       // 128
		virtual float                   CheckClampDamageModifier(ActorValue a_av, float a_delta);                                                                                                                        // 129
#endif
