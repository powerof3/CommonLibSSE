...
namespace RE
{
	...
	namespace BSScript
	{
		...
		{
		public:
			inline static auto RTTI = RTTI_BSScript__IVirtualMachine;
...
#endif
			bool                       FindBoundObject(VMHandle a_handle, const char* a_className, BSTSmartPointer<Object>& a_result) const;                                                                                   // 1C
			void                       MoveBoundObjects(VMHandle a_from, VMHandle a_to);                                                                                                                                       // 1D
			void                       ResetAllBoundObjects(VMHandle a_handle);                                                                                                                                                // 1E
			bool                       CastObject(const BSTSmartPointer<Object>& a_fromObjPtr, const BSTSmartPointer<ObjectTypeInfo>& a_toTypeInfoPtr, BSTSmartPointer<Object>& a_toObjPtr);                                   // 1F
			bool                       SetPropertyValue(BSTSmartPointer<Object>& a_obj, const char* a_propertyName, Variable& a_setVal);                                                                                       // 20
			bool                       GetPropertyValue(BSTSmartPointer<Object>& a_obj, const char* a_propertyName, Variable& a_getVal);                                                                                       // 21
			bool                       GetVariableValue1(const BSTSmartPointer<Object>& a_objPtr, std::uint32_t a_index, Variable& a_out) const;                                                                               // 22
			bool                       GetVariableValue2(VMHandle a_handle, const BSFixedString& a_className, std::int32_t a_variableIndex, Variable& a_out) const;                                                            // 23
			void                       SendEvent(VMHandle a_handle, const BSFixedString& a_eventName, IFunctionArguments* a_args);                                                                                             // 24
			void                       SendEventAll(const BSFixedString& a_eventName, IFunctionArguments* a_args);                                                                                                             // 25
			bool                       DispatchStaticCall(const BSFixedString& a_className, const BSFixedString& a_fnName, IFunctionArguments* a_args, BSTSmartPointer<IStackCallbackFunctor>& a_result);                      // 26
			bool                       DispatchMethodCall1(BSTSmartPointer<Object>& a_obj, const BSFixedString& a_fnName, IFunctionArguments* a_args, BSTSmartPointer<IStackCallbackFunctor>& a_result);                       // 27
			bool                       DispatchMethodCall2(VMHandle a_handle, const BSFixedString& a_className, const BSFixedString& a_fnName, IFunctionArguments* a_args, BSTSmartPointer<IStackCallbackFunctor>& a_result);  // 28
			bool                       DispatchUnboundMethodCall(void);                                                                                                                                                        // 29
			bool                       IsWaitingOnLatent(VMStackID a_stackID) const;                                                                                                                                           // 2A
			void                       ReturnFromLatent(VMStackID a_stackID, const Variable& a_val);                                                                                                                           // 2B
			ErrorLogger*               GetErrorLogger();                                                                                                                                                                       // 2C
			IObjectHandlePolicy*       GetObjectHandlePolicy1();                                                                                                                                                               // 2D
			const IObjectHandlePolicy* GetObjectHandlePolicy2() const;                                                                                                                                                         // 2E
			ObjectBindPolicy*          GetObjectBindPolicy1();                                                                                                                                                                 // 2F
			const ObjectBindPolicy*    GetObjectBindPolicy2() const;                                                                                                                                                           // 30
			ISavePatcherInterface*     GetSavePatcherInterface();                                                                                                                                                              // 31
			void                       RegisterForLogEvent(BSTEventSink<LogEvent>* a_sink);                                                                                                                                    // 32
			void                       UnregisterForLogEvent(BSTEventSink<LogEvent>* a_sink);                                                                                                                                  // 33
			void                       RegisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink);                                                                                                                                // 34
			void                       UnregisterForStatsEvent(BSTEventSink<StatsEvent>* a_sink);                                                                                                                              // 35
